...
export default function HowItWorks(){
    return(
        <div className="flex flex-col items-center text-4xl gap-10 mt-20 mb-20 bg-slate-400/50 dark:bg-slate-950 w-150 justify-self-center p-10 rounded-xl border-2 border-orange-600 shadow-lg shadow-orange-800/50">
