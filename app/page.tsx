  ...
  return (
    <div className="flex flex-col min-h-screen items-center bg-zinc-50 font-sans dark:bg-gray-950">
      ...
      <div className="w-full dark:bg-gray-900 flex flex-col pt-10 z-1">
        <Image src={"/images/Truck.png"} height={500} width={1500} alt="Truck Background" objectFit="cover" className="-z-1 w-full h-350 self-center mask-b-from-0% mask-b-to-100% mask-t-from-25% mask-t-to-100% top-0 absolute"/>
        <Hero />
